...
public class StuDipInfoController {
    ...
    public String updateStudentFamInfo(StuDipInfo stuDipInfo, Model model, HttpServletRequest request) {
        ...
        try {
            ...
            if (i > 0) {
                model.addAttribute("id", stuDipInfo.getStuId());
    ...
    public String toUpdateStudent(@RequestParam(value = "pg", defaultValue = "1") Integer pg,@RequestParam(value = "queryStuDipInfoById", required = false) String queryStuDipInfoById, Model model, HttpServletRequest request) {
        PageHelper.startPage(pg, 5);
