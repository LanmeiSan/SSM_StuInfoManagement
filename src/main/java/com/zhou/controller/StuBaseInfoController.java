...
//    }
    ...
    public String toUpdateStudent(@RequestParam(value = "pg", defaultValue = "1") Integer pg,@RequestParam(value = "queryStuById", required = false) String queryStuById, Model model, HttpServletRequest request) {
        PageHelper.startPage(pg, 5);
